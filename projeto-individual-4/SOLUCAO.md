...
├── test_pipeline.py        # Suite de testes TDD (40 testes)
...
A suite cobre **40 testes** organizados em 4 classes:

| Classe | Testes | Cobertura |
|--------|--------|-----------|
| `TestContratoSemantico` | 11 | Validações Pydantic (rejeição de dados inválidos) |
| `TestDatabase` | 8 | CRUD, idempotência por hash, CHECK constraints |
| `TestPipeline` | 11 | Hash, parsing, fallback, pipeline e2e, idempotência |
| `TestAPI` | 10 | Endpoints REST, upload, filtros, duplicatas |
